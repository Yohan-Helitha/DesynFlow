      ...
      <div className="bg-white p-6 rounded-md shadow-md w-full max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <table className="w-full text-sm border border-gray-300">
          ...
          <tbody>
            ...
            <tr>
              <td className="border px-2 py-1">Labor Cost</td>
              <td className="border px-2 py-1">
                <input
                  type="number"
                  value={laborCost}
            ...
            <tr>
              <td className="border px-2 py-1">Service Cost</td>
              <td className="border px-2 py-1">
                <input
                  type="number"
                  value={serviceCost}
            ...
            <tr>
              <td className="border px-2 py-1">Contingency Cost</td>
              <td className="border px-2 py-1">
                <input
                  type="number"
            ...
            <tr className="font-semibold bg-gray-50">
              <td className="border px-2 py-1">Total Cost</td>
