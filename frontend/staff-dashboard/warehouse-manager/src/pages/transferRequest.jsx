          ...
          <table className="min-w-max border-collapse border border-gray-300">
            <thead>
              <tr className="bg-gray-200">
                ...
                <th className="border border-gray-300 px-4 py-2">Required By</th>
              ...
              {requests.length > 0 ? (
                requests.map((request) => (
                  <tr key={request._id}>
                    ...
                    <td className="border border-gray-300 px-4 py-2">{request.requestedBy}</td>
                    <td className="border border-gray-300 px-4 py-2">{request.approvedBy}</td>
                    <td className="border border-gray-300 px-4 py-2">{request.status}</td>
                    <td className="border border-gray-300 px-4 py-2">{request.requiredBy ? new Date(request.requiredBy).toLocaleDateString() : "-"}</td>
                    <td className="border border-gray-300 px-4 py-2">{request.createdAt ? new Date(request.createdAt).toLocaleString() : "-"}</td>
                    <td className="border border-gray-300 px-4 py-2">{request.updatedAt ? new Date(request.updatedAt).toLocaleString() : "-"}</td>
                  </tr>
                ))
              ) : (
                <tr>
