...
//     if (filterBy === "id") {
//       return inventory.inventoryId?.toLowerCase().includes(query);
//     }
//     if (filterBy === "name") {
//       return inventory.inventoryName?.toLowerCase().includes(query);
//     }
//     if (filterBy === "address") {
//       return inventory.address?.toLowerCase().includes(query);
//     }
//     if (filterBy === "country") {
//       return inventory.country?.toLowerCase().includes(query);
//     }
...
//       inventory.address?.toLowerCase().includes(query) ||
...
//       const columns = [
//       "ID", "Name", "Address", "Country", "Capacity", "Contact", 
//       "Warehouse Manager Name", "Created At"
//       ];
...
//                     </li>
//                     <li
//                     className={`px-4 py-2 cursor-pointer hover:bg-gray-100 ${filterBy === "address" ? "bg-gray-200" : ""}`}
//                     onClick={() => { setFilterBy("address"); setSearchQuery(""); setShowFilter(false); }}
//                     >
//                     Address
//                     </li>
//                     <li
//                     className={`px-4 py-2 cursor-pointer hover:bg-gray-100 ${filterBy === "country" ? "bg-gray-200" : ""}`}
//                     onClick={() => { setFilterBy("country"); setSearchQuery(""); setShowFilter(false); }}
//                     >
//                     Country
//                     </li>
//                 </ul>
