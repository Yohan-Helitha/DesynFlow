          ...
          <table className="min-w-max border-collapse border border-gray-300">
            <thead>
              <tr className="bg-gray-200">
                ...
                <th className="border border-gray-300 px-4 py-2">Approved By</th>
                <th className="border border-gray-300 px-4 py-2">Employee ID</th>
                <th className="border border-gray-300 px-4 py-2">Vehicle Info</th>
              ...
              {movements.length > 0 ? (
                movements.map((movement) => (
                  <tr key={movement._id}>
                    ...
                    <td className="border border-gray-300 px-4 py-2">{movement.materialId}</td>
                    <td className="border border-gray-300 px-4 py-2">{movement.fromLocation}</td>
                    <td className="border border-gray-300 px-4 py-2">{movement.toLocation}</td>
                    <td className="border border-gray-300 px-4 py-2">{movement.unit}</td>
                    ...
                    <td className="border border-gray-300 px-4 py-2">{movement.requestedBy}</td>
                    <td className="border border-gray-300 px-4 py-2">{movement.approvedBy}</td>
                    <td className="border border-gray-300 px-4 py-2">{movement.employeeId}</td>
                    <td className="border border-gray-300 px-4 py-2">{movement.vehicleInfo}</td>
                    <td className="border border-gray-300 px-4 py-2">{movement.dispatchedDate ? new Date(movement.dispatchedDate).toLocaleDateString() : "-"}</td>
                    <td className="border border-gray-300 px-4 py-2">{new Date(movement.createdAt).toLocaleString()}</td>
                  </tr>
                ))
              ) : (
                <tr>
