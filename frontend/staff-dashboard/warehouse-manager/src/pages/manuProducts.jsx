    ...
    <div>
      ...
      <div className="m-6">
        <div className="flex justify-between items-center">
          ...
          <button className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded shadow mt-6 mb-10" onClick={() => navigate('/add-product')}>
            + Add Product
            </button>
        </div>
        ...
        <div className="overflow-x-auto">
            ...
            <thead>
                ...
                <th className="border border-gray-300 px-4 py-2">Warranty Period</th>
            ...
            <tbody className="align-middle text-center">
                ...
                products.map((product) => (
                    ...
                    <td className="border border-gray-300 px-4 py-2 sticky left-32 bg-white z-40 relative after:content-[''] after:absolute after:top-0 after:right-0 after:bottom-0 after:w-px after:bg-gray-300 after:z-50">{product.materialId}</td>
                    <td className="border border-gray-300 px-4 py-2 sticky left-64 bg-white z-40 relative after:content-[''] after:absolute after:top-0 after:right-0 after:bottom-0 after:w-px after:bg-gray-300 after:z-50">{product.materialName}</td>
                    ...
                    <td className="border border-gray-300 px-4 py-2">{product.inventoryId}</td>
