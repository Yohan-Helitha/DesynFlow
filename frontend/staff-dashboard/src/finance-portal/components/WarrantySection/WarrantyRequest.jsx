				...
				<div className="overflow-x-auto">
					<table className="min-w-full divide-y divide-[#AAB396]">
						...
						<tbody className="bg-[#FFF8E8] divide-y divide-[#AAB396]">
							{loading && (
								<tr><td colSpan={columns.length + 1} className="px-6 py-4 text-center text-[#674636]">Loading pending claims...</td></tr>
							)}
							{!loading && pageSlice.length === 0 && (
								<tr><td colSpan={columns.length + 1} className="px-6 py-4 text-center text-[#AAB396]">No pending claims found</td></tr>
							)}
