  ...
  useEffect(() => {
    const getStockMovement = async () => {
      try {
        ...
        console.error("Failed to fetch stock movement:", err);
        setErrors({ general: "Failed to load stock movement data" });
      } finally {
        setIsLoading(false);
      }
    };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        {/* Header Section */}
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Update Stock Movement</h1>
          <p className="text-gray-600">Update existing stock movement record for inventory transfer</p>
        </div>
            ...
            <div className={sectionClass}>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  <div className="font-medium text-blue-900 mb-1">Update Stock Movement</div>
                  <div className="text-sm text-blue-700">
                    Update existing stock movement record for transferring inventory between locations.
                  </div>
                </div>
