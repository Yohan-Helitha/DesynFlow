        ...
        <div className="border-2 border-gray-300 m-auto p-8 w-xl shadow bg-[#FFF8E8]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-sm max-w-3xl">
            ...
            <div className="flex gap-4 pt-6">
              ...
              <button type="button" onClick={() => navigate("/reorder-request")} className="bg-gray-600 hover:bg-gray-700 text-white font-semibold py-2 px-6 rounded-md">Cancel</button>
            </div>
          </form>
        </div>
      </div>
