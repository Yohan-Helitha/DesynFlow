  ...
  useEffect(() => {
    const getTransferRequest = async () => {
      try {
        ...
        console.error("Failed to fetch transfer request:", err);
        setErrors({ general: "Failed to load transfer request data" });
      } finally {
        setIsLoading(false);
      }
    };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        {/* Header Section */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Update Transfer Request</h1>
          <p className="text-gray-600">Update existing transfer request for inventory movement</p>
        </div>
            ...
            <div className={sectionClass}>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  <div className="font-medium text-blue-900 mb-1">Update Transfer Request</div>
                  <div className="text-sm text-blue-700">
                    Update existing transfer request for moving inventory between locations.
                  </div>
                </div>
                ...
                <div className="text-xs text-gray-500">
                  <p>Material ID cannot be changed once created.</p>
                </div>
                <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                  ...
                  <p className="text-yellow-700 text-xs mt-1">
                    Changing status to "Approved" will process the transfer request.
                  </p>
                </div>
              </div>
            </div>
